...
void setup(void) {  
  ...
  //spi2.begin();
  //spi2.beginTransaction(SPISettings(36000000, MSBFIRST, SPI_MODE0));
  //spi2.write(0x01);
  //spi2.endTransaction();
  pinMode(PC13,OUTPUT);
  ...
  Serial.print("Draw Circle : ");
  Serial.println(millis() - time);
  delay(500);

  time = millis();
  testroundrects();
  Serial.print("Draw Round Rect : ");
  Serial.println(millis() - time);
  delay(500);

  time = millis();
  testtriangles();
  Serial.print("Draw Triangles : ");
  Serial.println(millis() - time);
  delay(500);
