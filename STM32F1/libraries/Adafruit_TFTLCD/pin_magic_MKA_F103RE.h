...
#define DELAY10 asm volatile("nop;nop;nop;nop;nop;nop;nop;nop;nop;nop;");
#define DELAY40 DELAY10;DELAY10;DELAY10;DELAY10
...
DATA_PORT->regs->BSRR = (d&0xFF)|((~(d<<16))&0x00FF0000);\
WR_STROBE; }
#define read8inline(result) { \
RD_ACTIVE; \
DELAY40; \
result = (DATA_PORT->regs->IDR); \
RD_IDLE; }
#define setWriteDirInline() { DATA_PORT->regs->CRL = 0x33333333; }
#define setReadDirInline() { DATA_PORT->regs->CRL = 0x88888888; }
...
#define RD_ACTIVE rdPort->regs->BRR = rdPinSet
#define RD_IDLE rdPort->regs->BSRR = rdPinSet
#define WR_ACTIVE wrPort->regs->BRR = wrPinSet
#define WR_IDLE wrPort->regs->BSRR = wrPinSet
#define CD_COMMAND cdPort->regs->BRR = cdPinSet
#define CD_DATA cdPort->regs->BSRR = cdPinSet
#define CS_ACTIVE csPort->regs->BRR = csPinSet
#define CS_IDLE csPort->regs->BSRR = csPinSet
#endif
